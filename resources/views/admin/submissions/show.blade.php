            ...
            <div class="p-6 text-gray-900">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <div class="flex space-x-2">
                        <a href="{{ route('admin.submissions') }}" class="bg-gray-500 hover:bg-gray-700 text-white font-bold py-2 px-4 rounded">
                            Kembali
                        </a>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <dl class="space-y-3">
                            ...
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900">{{ $submission->guideline ? strtoupper($submission->guideline->type) : 'N/A' }}</dd>
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            @foreach($documents as $doc)
                                <div class="border border-gray-200 rounded-lg p-4">
                                    <div class="flex items-center justify-between">
                                        <div class="flex-1">
                                            <p class="text-sm font-medium text-gray-900 truncate">{{ $doc['original_name'] ?? $doc['stored_name'] ?? 'Document' }}</p>
                                            <p class="text-xs text-gray-500">{{ isset($doc['uploaded_at']) ? \Carbon\Carbon::parse($doc['uploaded_at'])->format('d/m/Y H:i') : 'N/A' }}</p>
                                            @if(isset($doc['size']))
                                                <p class="text-xs text-gray-400">{{ number_format($doc['size'] / 1024, 1) }} KB</p>
                                            @endif
                                        </div>
                                        @if(isset($doc['path']))
